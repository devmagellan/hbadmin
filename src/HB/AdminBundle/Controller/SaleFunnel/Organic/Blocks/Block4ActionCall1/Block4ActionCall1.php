...
use HB\AdminBundle\Form\SaleFunnel\Organic\Block4ActionCall1Type;
...
class Block4ActionCall1
{
    ...
    public function handleAction(SalesFunnelOrganic $funnel, Request $request)
    {
        ...
        $form = $this->formFactory->create(Block4ActionCall1Type::class, $funnel);
        $saved = false;
        ...
        $content = $this->twig->render('@HBAdmin/SaleFunnel/Organic/blocks/block4.html.twig', [
            'saved' => $saved,
            'funnel' => $funnel,
