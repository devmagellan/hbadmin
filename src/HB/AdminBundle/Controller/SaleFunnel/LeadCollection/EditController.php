...
class EditController
{
    ...
    {
        $funnel = new SalesFunnelLeadCollection($course);

        $this->access->resolveCreateAccess($funnel);
        $this->access->registerEvent(IntercomEvents::ACCESS_FUNNEL_LEADS);
        ...
        $content = $this->twig->render('@HBAdmin/SaleFunnel/LeadCollection/edit.html.twig', [
            'course'                 => $course,
            'funnel'                 => $funnel,
