...
class LessonElementTextEditController
{
    /**
     * @var RouterInterface
     */
    ...
    /**
     * LessonElementTextEditController constructor.
     *
    ...
    public function handleAction(LessonElement $element, Request $request): Response
    {
        ...
        if (LessonElementType::TEXT !== $element->getType()->getValue()) {
            $this->flashBag->add('error', 'Ошибка редактирования текста');
            return new RedirectResponse($referer);
        }

        $form = $this->formFactory->create(LessonElementTextType::class, $element);
        ...
        $content = $this->twig->render('@HBAdmin/LessonElement/element_text_edit.html.twig', [
